  ...
  static void demo() {
              ...
              << "Walmart::demo() starting..." << std::endl;
    {
      ...
      walmart.addInventory(
          ItemFactory::getItem("Wonder bread", 1.49, 2, ItemFactory::ITEM));
      walmart.addInventory(
      ...
      walmart.addEmployees(PersonFactory::getPerson("Dan", "Peters", 1001, 17,PersonFactory::PERSON));
      walmart.addEmployees(PersonFactory::getPerson("Sam", "Sneed", 1003, 19,PersonFactory::PERSON));
      walmart.addEmployees(PersonFactory::getPerson("Jane", "Eyre", 1002, 39,PersonFactory::PERSON));
